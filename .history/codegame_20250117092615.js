...
const questions = [
  ...
  {
    question:
      "In MongoDB, what is the default ID field created in each document?",
    options: ["_id", "id", "_docID", "_mongoID"],
    answer: "_id",
    topic: "MongoDB",
  },
  {
    question:
      "Which principle refers to the practice of ensuring user interfaces are simple and easy to use?",
    options: [
      "User-centered design",
      "Consistency",
      "Aesthetic design",
  ...
  {
    question:
      "Which function is used to handle state in functional components in React?",
    options: ["setState", "useEffect", "useState", "handleState"],
    answer: "useState",
    topic: "React.js",
  },
  ...
  {
    question:
      "Which of the following libraries can be used to navigate between screens in React Native?",
    options: ["React Router", "React Navigation", "Flux", "Axios"],
    answer: "React Navigation",
    topic: "React Native",
  },
  ...
  return new Promise((resolve) => {
    ...
    process.stdin.on("keypress", (char, key) => {
      if (key && key.name === "return") {
        ...
        clearLine();
        process.stdout.write(
          `Time remaining: ${remainingTime}s | Your answer (1-4): ${userInput}`
        );
    ...
    process.stdout.write(
      `Time remaining: ${remainingTime}s | Your answer (1-4): `
    );
